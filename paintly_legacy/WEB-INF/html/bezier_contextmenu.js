...
function showContextMenuBez(x,y){
  ...
  contextmenu.setCallBackOnClose("closeBezMenuCallBack");
...
function toLineBez(){
  //var s=focusedMobilePointNum-4;
  var point =focusedMobilePointNum-3;
  //var e=focusedMobilePointNum-2;
  //if(s<6){s=e;}
  //if(e>=focusedBez.length){e=s;}
  //var mlength = Math.sqrt((focusedBez[point][p][0]-focusedBez[point][m][0])*(focusedBez[point][p][0]-focusedBez[point][m][0])+(focusedBez[point][p][1]-focusedBez[point][m][1])*(focusedBez[point][p][1]-focusedBez[point][m][1]));
  //var rlength = Math.sqrt((focusedBez[point][p][0]-focusedBez[point][r][0])*(focusedBez[point][p][0]-focusedBez[point][r][0])+(focusedBez[point][p][1]-focusedBez[point][r][1])*(focusedBez[point][p][1]-focusedBez[point][r][1]));
  //var toeLength = Math.sqrt((focusedBez[point][p][0]-focusedBez[e][p][0])*(focusedBez[point][p][0]-focusedBez[e][p][0])+(focusedBez[point][p][1]-focusedBez[e][p][1])*(focusedBez[point][p][1]-focusedBez[e][p][1]));
  //var tosLength = Math.sqrt((focusedBez[s][p][0]-focusedBez[point][p][0])*(focusedBez[s][p][0]-focusedBez[point][p][0])+(focusedBez[s][p][1]-focusedBez[point][p][1])*(focusedBez[s][p][1]-focusedBez[point][p][1]));
//  focusedBez[point][m][0] = Math.round(focusedBez[point][p][0]-(focusedBez[point][p][0]-focusedBez[e][p][0])/(toeLength/mlength));
//  focusedBez[point][m][1] = Math.round(focusedBez[point][p][1]-(focusedBez[point][p][1]-focusedBez[e][p][1])/(toeLength/mlength));
//  focusedBez[point][r][0] = Math.round(focusedBez[point][p][0]-(focusedBez[point][p][0]-focusedBez[s][p][0])/(tosLength/rlength));
//  focusedBez[point][r][1] = Math.round(focusedBez[point][p][1]-(focusedBez[point][p][1]-focusedBez[s][p][1])/(tosLength/rlength));
