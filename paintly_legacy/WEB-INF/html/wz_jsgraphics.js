...
text both horizontally (e.g. right) and vertically within that rectangle */
   ...
   this.drawBezier = function(x0,y0,x1,y1,x2,y2,x3,y3){
	...
	var yy1=Math.round(o_t_3*y0+3*t*o_t_2*y1+3*t_2*(1-t)*y2+t_3*y3);
        ...
        //this.drawRect(xx0-1,yy0-1,2,2);
        xx0=xx1;yy0=yy1;
      }
    }
   
    this.sketchBezier = function(x0,y0,x1,y1,x2,y2,x3,y3,iteration){
       ...
       this.sketchBezier(res[0],res[1],res[2],res[3],res[4],res[5],res[6],res[7],iteration-1);
       this.sketchBezier(res[8],res[9],res[10],res[11],res[12],res[13],res[14],res[15],iteration-1);
