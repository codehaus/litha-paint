...
function drawMobilePointsRot(num,x,y,w,h){
  ...
  if(num==0){
    jg.drawImage("img/rot_top_left.gif",x,y,w,h,"rotate");
  }
  else if(num==1){
    jg.drawImage("img/skew_hor.gif",x,y,w,h,"rotate");
  }
  else if(num==2){
    jg.drawImage("img/rot_top_right.gif",x,y,w,h,"rotate");
  }
  else if(num==3){
    jg.drawImage("img/skew_ver.gif",x,y,w,h,"rotate");
  }
  else if(num==4){
    jg.drawImage("img/rot_bottom_right.gif",x,y,w,h,"rotate");
  }
  else if(num==5){
    jg.drawImage("img/skew_hor.gif",x,y,w,h,"rotate");
  }
  else if(num==6){
    jg.drawImage("img/rot_bottom_left.gif",x,y,w,h,"rotate");
  }
  else if(num==7){
    jg.drawImage("img/skew_ver.gif",x,y,w,h,"rotate");
  }
...
function highlightFocusedBezRot(evt){
   ...
   if(focusedMobilePointNum==0 || focusedMobilePointNum==2 || focusedMobilePointNum==4 || focusedMobilePointNum==6){
     ...
     jg.setColor('#000000');	   
     canvas.style.cursor = "url(img/rot.cur)";
