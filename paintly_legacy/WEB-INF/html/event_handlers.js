...
eventHandler[0]["onkeydown"] = "processKeyDownFocusedBez";
eventHandler[0]["onkeyup"] = "processKeyUpFocusedBez";
...
eventHandler[3]["onkeydown"] = "processKeyDownSelectRegion";
eventHandler[3]["onkeyup"] = "processKeyUpSelectRegion";
...
eventHandler[5]["onkeydown"] = "processKeyDownPoly";
...
eventHandler[9]["onkeydown"] = "processKeyDownBez";
eventHandler[9]["onkeyup"] = "processKeyUpBez";
...
eventHandler[10]["onkeydown"] = "processKeyDownFocusedBez";
eventHandler[10]["onkeyup"] = "processKeyUpFocusedBez";
...
eventHandler[14]["onkeydown"]   = "processOnKeyDownFocusedText";
eventHandler[14]["onkeyup"]   = "processOnKeyUpFocusedText";
...
eventHandler[16]["onkeydown"]   = "processOnKeyDownFocusedText";
eventHandler[16]["onkeyup"]   = "processOnKeyUpFocusedText";
...
eventHandler[22]["onkeydown"] = "processKeyDownContextMenu";
...
eventHandler[24]["onkeydown"] = "processKeyDownFocusedBez";
eventHandler[24]["onkeyup"] = "processKeyUpFocusedBez";
...
eventHandler[31]["onkeydown"] = "processKeyDownHand";
eventHandler[31]["onkeyup"] = "processKeyUpHand";

eventHandler[32] = new Array(); //user picks save file dialog and types file name and clicks OK button or press ENTER
eventHandler[32]["onmousedown"] = "dummy";
eventHandler[32]["onmousemove"] = "dummy";
eventHandler[32]["onmouseup"] = "dummy";
eventHandler[32]["onkeydown"] = "processOnKeyDownSaveFile";
eventHandler[32]["onkeyup"] = "dummy";

eventHandler[33] = new Array(); //user picks new file dialog and types file name and clicks OK button or press ENTER
eventHandler[33]["onmousedown"] = "dummy";
eventHandler[33]["onmousemove"] = "dummy";
eventHandler[33]["onmouseup"] = "dummy";
eventHandler[33]["onkeydown"] = "processOnKeyDownNewFile";
eventHandler[33]["onkeyup"] = "dummy";

eventHandler[34] = new Array(); //user picks open file dialog and types file name and clicks OK button or press ENTER
eventHandler[34]["onmousedown"] = "dummy";
eventHandler[34]["onmousemove"] = "dummy";
eventHandler[34]["onmouseup"] = "dummy";
eventHandler[34]["onkeydown"] = "processOnKeyDownOpenFile";
eventHandler[34]["onkeyup"] = "dummy";

eventHandler[35] = new Array(); //user press Enter on ColorPicker -> release choosing color
eventHandler[35]["onkeydown"] = "releaseCPicker";
eventHandler[35]["onmousemove"] = "dummy";
eventHandler[35]["onmousedown"] = "dummy";
eventHandler[35]["onmouseup"] = "dummy";
eventHandler[35]["onkeyup"] = "dummy";
eventHandler[35]["onclick"] = "dummy";

eventHandler[36] = new Array(); //user press Enter on LinePicker -> release choosing line style
eventHandler[36]["onkeydown"] = "releaseLPicker";
eventHandler[36]["onmousemove"] = "dummy";
eventHandler[36]["onmousedown"] = "dummy";
eventHandler[36]["onmouseup"] = "dummy";
eventHandler[36]["onkeyup"] = "dummy";
eventHandler[36]["onclick"] = "dummy";

eventHandler[37] = new Array(); //user press Enter on LinePicker -> release choosing line style
eventHandler[37]["onkeydown"] = "dummy";
eventHandler[37]["onmousemove"] = "dummy";
eventHandler[37]["onmousedown"] = "dummy";
eventHandler[37]["onmouseup"] = "dummy";
eventHandler[37]["onkeyup"] = "dummy";
eventHandler[37]["onclick"] = "processColorMouseClick";
eventHandler[37]["onkeydown"] = "processKeyDownFocusedBez";
eventHandler[37]["onkeyup"] = "processKeyUpFocusedBez";

eventHandler[38] = new Array(); //user picks save file dialog and types file name and clicks OK button or press ENTER
eventHandler[38]["onmousedown"] = "dummy";
eventHandler[38]["onmousemove"] = "dummy";
eventHandler[38]["onmouseup"] = "dummy";
eventHandler[38]["onkeydown"] = "processOnKeyDownPublishFile";
eventHandler[38]["onkeyup"] = "dummy";

eventHandler[39] = new Array(); //user picks upload file dialog and types file name and clicks OK button or press ENTER
eventHandler[39]["onmousedown"] = "dummy";
eventHandler[39]["onmousemove"] = "dummy";
eventHandler[39]["onmouseup"] = "dummy";
eventHandler[39]["onkeydown"] = "processOnKeyDownUploadFile";
eventHandler[39]["onkeyup"] = "dummy";

eventHandler[41] = new Array(); //user picks save file dialog and types file name and clicks OK button or press ENTER
eventHandler[41]["onmousedown"] = "dummy";
eventHandler[41]["onmousemove"] = "dummy";
eventHandler[41]["onmouseup"] = "dummy";
eventHandler[41]["onkeydown"] = "processOnKeyDownBugReport";
eventHandler[41]["onkeyup"] = "dummy";

eventHandler[42] = new Array(); //user picks save file dialog and types file name and clicks OK button or press ENTER
eventHandler[42]["onmousedown"] = "dummy";
eventHandler[42]["onmousemove"] = "dummy";
eventHandler[42]["onmouseup"] = "dummy";
eventHandler[42]["onkeydown"] = "processOnKeyDownExportFile";
eventHandler[42]["onkeyup"] = "dummy";

eventHandler[43] = new Array(); //user picks save file dialog and types file name and clicks OK button or press ENTER
eventHandler[43]["onmousedown"] = "dummy";
eventHandler[43]["onmousemove"] = "dummy";
eventHandler[43]["onmouseup"] = "dummy";
eventHandler[43]["onkeydown"] = "menu_doc_dialog_cancel";
eventHandler[43]["onkeyup"] = "dummy";

eventHandler[44] = new Array(); //user press "insert image" and types file name and clicks OK button or press ENTER
eventHandler[44]["onmousedown"] = "dummy";
eventHandler[44]["onmousemove"] = "dummy";
eventHandler[44]["onmouseup"] = "dummy";
eventHandler[44]["onkeydown"] = "processOnKeyDownInsertImage";
eventHandler[44]["onkeyup"] = "dummy";
...
eventHandler[45]["onkeydown"] = "processKeyDownFocusedImage";
eventHandler[45]["onkeyup"] = "processKeyUpFocusedImage";
...
//var focusedObjectDiv;

function switchSquare(){
//  if(tool_selected != 0){
    toolHoockerBefore();
    if(ellipseV !=null) ellipseV.src = "img/icons/ellipse.gif";
  	if(squareV !=null)squareV.src = "img/icons/square_pressed.gif";
  	if (arrowV != null) arrowV.src="img/icons/arrow.gif";
	if (singlelineV != null) singlelineV.src="img/icons/line.gif";
	if (polylineV != null) polylineV.src="img/icons/polyline.gif";
	if (polygonV != null) polygonV.src="img/icons/polygon.gif";	
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";	
	if (textV != null) textV.src="img/icons/text.gif";
      if (penV != null) penV.src = "img/icons/pen.gif";
      if (lassoV != null) lassoV.src = "img/icons/lasso.gif";
      if (handV != null) handV.src = "img/icons/hand.gif";
	if (applyFillColor) applyFillColor.src = "img/icons/fill.gif";
	if (applyStrokeColor) applyStrokeColor.src = "img/icons/stroke.gif";
  	tool_selected = 0;
...
//  if(tool_selected != 1){
    toolHoockerBefore();
  	if(ellipseV !=null) ellipseV.src = "img/icons/ellipse_pressed.gif";
  	if (squareV != null) squareV.src = "img/icons/square.gif";
  	if (arrowV != null) arrowV.src="img/icons/arrow.gif";
	if (singlelineV != null) singlelineV.src="img/icons/line.gif";
	if (polylineV != null) polylineV.src="img/icons/polyline.gif";
	if (polygonV != null) polygonV.src="img/icons/polygon.gif";		
...
//  if(tool_selected != 2){
    toolHoockerBefore();
  	if(ellipseV != null) ellipseV.src = "img/icons/ellipse.gif";
  	if (squareV != null) squareV.src = "img/icons/square.gif";
  	if (arrowV != null) arrowV.src="img/icons/arrow_pressed.gif";
	if (singlelineV != null) singlelineV.src="img/icons/line.gif";	
	if (polylineV != null) polylineV.src="img/icons/polyline.gif";
	if (polygonV != null) polygonV.src="img/icons/polygon.gif";	
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";
...
//  if(tool_selected != 3){
    toolHoockerBefore();
  	...
  	if (squareV != null) squareV.src = "img/icons/square.gif";
  	if (arrowV != null) arrowV.src="img/icons/arrow.gif";
	if (singlelineV != null) singlelineV.src="img/icons/line_pressed.gif";	
	if (polylineV != null) polylineV.src="img/icons/polyline.gif";	
	if (polygonV != null) polygonV.src="img/icons/polygon.gif";	
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";
	if (textV != null) textV.src="img/icons/text.gif";
...
//  if(tool_selected != 4){
    toolHoockerBefore();
  	...
  	if (arrowV != null) arrowV.src="img/icons/arrow.gif";
	if (singlelineV != null) singlelineV.src="img/icons/line.gif";	
	if (polylineV != null) polylineV.src="img/icons/polyline_pressed.gif";	
	if (polygonV != null) polygonV.src="img/icons/polygon.gif";	
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";
	if (textV != null) textV.src="img/icons/text.gif";
      if (penV != null) penV.src = "img/icons/pen.gif";
...
//  if(tool_selected != 5){
	...
	if (singlelineV != null) singlelineV.src="img/icons/line.gif";	
	if (polylineV != null) polylineV.src="img/icons/polyline.gif";	
	if (polygonV != null) polygonV.src="img/icons/polygon_pressed.gif";	
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";
	if (textV != null) textV.src="img/icons/text.gif";
      if (penV != null) penV.src = "img/icons/pen.gif";
      if (lassoV != null) lassoV.src = "img/icons/lasso.gif";
...
//  if(tool_selected != 6){
	...
	if (polylineV != null) polylineV.src="img/icons/polyline.gif";	
	if (polygonV != null) polygonV.src="img/icons/polygon.gif";	
	if (bezierV != null) bezierV.src="img/icons/bezier_pressed.gif";
	if (textV != null) textV.src="img/icons/text.gif";
      if (penV != null) penV.src = "img/icons/pen.gif";
      if (lassoV != null) lassoV.src = "img/icons/lasso.gif";
      if (handV != null) handV.src = "img/icons/hand.gif";
...
//    if(tool_selected != 7){
	...
	if (polygonV != null) polygonV.src="img/icons/polygon.gif";	
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";
      if (textV != null) textV.src="img/icons/text_pressed.gif";
      if (penV != null) penV.src = "img/icons/pen.gif";
      if (lassoV != null) lassoV.src = "img/icons/lasso.gif";
      if (handV != null) handV.src = "img/icons/hand.gif";
	if (applyFillColor) applyFillColor.src = "img/icons/fill.gif";
...
//    if(tool_selected != 8){
	...
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";
      if (textV != null) textV.src="img/icons/text.gif";
      if (penV != null) penV.src = "img/icons/pen_pressed.gif";
      if (lassoV != null) lassoV.src = "img/icons/lasso.gif";
      if (handV != null) handV.src = "img/icons/hand.gif";
	if (applyFillColor) applyFillColor.src = "img/icons/fill.gif";
	if (applyStrokeColor) applyStrokeColor.src = "img/icons/stroke.gif";
...
//    if(tool_selected != 9){
	...
	if (bezierV != null) bezierV.src="img/icons/bezier.gif";
      if (textV != null) textV.src="img/icons/text.gif";
      if (penV != null) penV.src = "img/icons/pen.gif";
      if (lassoV != null) lassoV.src = "img/icons/lasso_pressed.gif";
      if (handV != null) handV.src = "img/icons/hand.gif";
	if (applyFillColor) applyFillColor.src = "img/icons/fill.gif";
	if (applyStrokeColor) applyStrokeColor.src = "img/icons/stroke.gif";
      tool_selected = 9;
...
function switchStrokeColor(){
	...
	colorPicker.init('strokeColor', colorPickerID);
    mgn.setNextEventHandler(colorPicker.getNextEventHandler());	
	mgn.displayWindow('', colorPickerID, 'Stroke Color Picker');
}
...
function switchFillColor(){
	...
	colorPicker.init('fillColor', colorPickerID);
        mgn.setNextEventHandler(colorPicker.getNextEventHandler());
	mgn.displayWindow('', colorPickerID, 'Fill Color Picker');
}
...
function switchApplyStrokeColor(){
	...
	if (lassoV != null) lassoV.src = "img/icons/lasso.gif";    
        if (handV != null) handV.src = "img/icons/hand.gif";
	if (applyFillColor) applyFillColor.src = "img/icons/fill.gif";
	if (applyStrokeColor) applyStrokeColor.src = "img/icons/stroke_pressed.gif";
	toolHooker(tool_selected);
...
function switchApplyFillColor(){
	...
	if (lassoV != null) lassoV.src = "img/icons/lasso.gif";    
        if (handV != null) handV.src = "img/icons/hand.gif";
	if (applyFillColor) applyFillColor.src = "img/icons/fill_pressed.gif";
	if (applyStrokeColor) applyStrokeColor.src = "img/icons/stroke.gif";
	toolHooker(tool_selected);
...
function switchHand(){
	...
	if (penV != null) penV.src = "img/icons/pen.gif";
        if (lassoV != null) lassoV.src = "img/icons/lasso.gif";
	if (handV != null) handV.src = "img/icons/hand_pressed.gif";
	if (applyFillColor) applyFillColor.src = "img/icons/fill.gif";
	if (applyStrokeColor) applyStrokeColor.src = "img/icons/stroke.gif";
	tool_selected = 10;
	toolHooker(tool_selected);
...
function switchStrokeType(){
	...
	mgn.setNextEventHandler(linePicker.getNextEventHandler());
	mgn.displayWindow('', linePickerID, '');
}

function switchInsertImg(){
    toolHoockerBefore();
        lostFocus();
	performInsertImage();
...
function move(evt){
	...
	if ((evt?(evt.button==65535 || evt.button == 0):event.button==1) && dragapproved == true){	
		...
		if(tool_selected == 1) jg.drawEllipse(x-canvas_x, y-canvas_y, w, h);
		jg.paint();
		left = x;
		top = y;
		width = w;
...
function setDocumentHandlersSet(i){

	if(eventHandler[i]["onmousedown"]) setEventDocument("onmousedown",eventHandler[i]["onmousedown"]);
	if(eventHandler[i]["onmouseup"]) setEventDocument("onmouseup",eventHandler[i]["onmouseup"]);
	if(eventHandler[i]["onmousemove"]) setEventDocument("onmousemove",eventHandler[i]["onmousemove"]);
	if(eventHandler[i]["onkeypress"]) setEventDocument("onkeypress",eventHandler[i]["onkeypress"]);
        if(eventHandler[i]["onkeydown"]) setEventDocument("onkeydown",eventHandler[i]["onkeydown"]);
        if(eventHandler[i]["onkeyup"]) setEventDocument("onkeyup",eventHandler[i]["onkeyup"]);
        if(eventHandler[i]["ondblclick"]) setEventDocument("ondblclick",eventHandler[i]["ondblclick"]);
        if(eventHandler[i]["onclick"]) setEventDocument("onclick",eventHandler[i]["onclick"]);

	curEventHandler=i;
}


function removeDocumentHandlersSet(i){
	if(eventHandler[curEventHandler]["onmousedown"]) removeEventDocument("onmousedown",eventHandler[curEventHandler]["onmousedown"]);
	if(eventHandler[curEventHandler]["onmouseup"]) removeEventDocument("onmouseup",eventHandler[curEventHandler]["onmouseup"]);
        if(eventHandler[curEventHandler]["onkeypress"]) removeEventDocument("onkeypress",eventHandler[curEventHandler]["onkeypress"]);
        if(eventHandler[curEventHandler]["onkeydown"]) removeEventDocument("onkeydown",eventHandler[curEventHandler]["onkeydown"]);
        if(eventHandler[curEventHandler]["onkeyup"]) removeEventDocument("onkeyup",eventHandler[curEventHandler]["onkeyup"]);
        if(eventHandler[curEventHandler]["ondblclick"]) removeEventDocument("ondblclick",eventHandler[curEventHandler]["ondblclick"]);
        if(eventHandler[curEventHandler]["onclick"]) removeEventDocument("onclick",eventHandler[curEventHandler]["onclick"]);
}

function setEvent(evt,funcStr){
	if(document.all){	
	    eval("canvas."+evt+"="+funcStr);
