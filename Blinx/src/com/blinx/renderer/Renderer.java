...
//      set the width and height attribute on the root svg element
        ...
        Element back = SVGDocumentTools.createBackgroundElement(res,document,canvas.getScrapsX()*ConstantsBulk.SCRAPWIDTH, canvas.getScrapsY()*ConstantsBulk.SCRAPHEIGHT);
        if (back != null) {
    ...
    /**
     * Changes backgroundcolor for document
     * @param background background color
     */
	public void changeBackgroundColor(Color background) {
		document.setBackgroundColor(background);
		interest.add(new Rectangle(0,0,canvas.getScrapsX()*ConstantsBulk.SCRAPWIDTH,canvas.getScrapsY()*ConstantsBulk.SCRAPHEIGHT));
