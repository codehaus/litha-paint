 ...
 * The HashMap consists of document fragments {@link com.blinx.renderer.DocumentFragment#DocumentFragment(Shape)}
 * There is rarely a need to use this class directly, rather by Renderer {@link com.blinx.renderer.Renderer#Renderer(CanvasScrapHolder, DocumentHolder)}  
 * @author VyacheslavE
 * @version Apr 14, 2006
 */
public class DocumentHolder {
    ...
    private Color backgroundColor = ConstantsBulk.COLOR_ALPHA;
    ...
    public String toString(){
        String res="<documentholder"+bgColorToString()+">\n";
        Iterator it = documentFragments.keySet().iterator();
        while(it.hasNext()){
           Integer id = (Integer)it.next();
    ...
    private String bgColorToString() {
    	String res ="";
    	if (!backgroundColor.equals(ConstantsBulk.COLOR_ALPHA)) {
    		res = " bgcolor=\""+backgroundColor.toString()+"\"";
    	}
    	return res;
	}
