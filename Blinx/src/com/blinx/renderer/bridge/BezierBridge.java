...
public class BezierBridge implements ShapeBridge{
    ...
    public Shape getShape(Map attributes) {
        ...
        try {
            ...
            bezier = new Bezier(points, strokeColor, fillColor, id,left,top,width,height, Double.parseDouble(fillOpacity), Integer.parseInt(strokeWidth), Double.parseDouble(strokeOpacity), strokeDasharray, strokeLinecap, strokeLinejoin, Double.parseDouble(strokeMiterlimit), fillRule);
        } catch (Exception e) {
